...
class Customer(models.Model):
    ...
    introduce_from = models.ForeignKey('self', verbose_name="转介绍自学员", blank=True,
                                       null=True,on_delete=models.CASCADE)  # self指的就是自己这个表，和下面写法是一样的效果
    ...
    # 用户表中存放的是自己公司的所有员工。
    consultant = models.ForeignKey('rbac.UserInfo', verbose_name="销售", blank=True, null=True,on_delete=models.CASCADE)
...
class ConsultRecord(models.Model):
    ...
    consultant = models.ForeignKey("rbac.UserInfo", verbose_name="跟进人", related_name='records',on_delete=models.CASCADE)
...
class Enrollment(models.Model):
    ...
    school = models.ForeignKey('education.Campuses',on_delete=models.CASCADE)  # 校区表

    enrollment_class = models.ForeignKey("education.ClassList", verbose_name="所报班级",on_delete=models.CASCADE)
